  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        fontFamily:
            'Inter', // To use the Inter font, you need to include it in your pubspec.yaml.
      ),
      home:
          const ProductActionScreen(), // ProductActionScreen is the main screen.
    );
  }
}
          ...
          child: Container(
            ...
            child: Column(
              mainAxisSize: MainAxisSize
                  .min, // Column height will be based on its children
              crossAxisAlignment:
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment
                      .spaceBetween, // Distribute elements evenly
                  children: [
                    const Text(
                ...
                const SizedBox(
                  height: 24,
                ), // Space between options list and button
                // 'Add To Cart' button
                ElevatedButton(
                  onPressed: () {
